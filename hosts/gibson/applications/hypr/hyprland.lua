return function(WS)
  ...
  ------------------------------------------------------------------------
  -- KEYBINDS: window management / mouse
  ------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
  -- KEYBINDS: media / volume / screenshots
  ------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
  -- KEYBINDS: workspace focus / window move
  ------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
  -- WINDOW RULES: workspace placement
  ------------------------------------------------------------------------
  ...
  ------------------------------------------------------------------------
  -- WINDOW RULES: floating / sizing quirks
  ------------------------------------------------------------------------
  hl.window_rule({
  ...
  hl.window_rule({ match = { class = "^explorer.exe$" }, float = true,  move  = "-2000 -2000", size  = "1 1", no_focus = true })
  ...
  hl.on("hyprland.start", function()
    ...
    hl.exec_cmd("sleep 3 && signal-desktop")
    hl.exec_cmd("sleep 0.5 && hyprctl dispatch moveintogroup l")
