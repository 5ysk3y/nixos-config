return function(WS)
  ...
  hl.window_rule({ match = { class = "^(discord)$" }, group = "set" })
  hl.window_rule({ match = { class = "^(signal)$" }, group = "invade" })
  hl.window_rule({ match = { class = "^(Cider)$" }, group = "set" })
  hl.window_rule({ match = { class = "^(org.jellyfin.JellyfinDesktop)$" }, group = "invade" })
