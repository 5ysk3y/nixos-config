...
in
{
  ...
  config =
    ...
    mkIf config.confSymlinks.enable {
      ## Symlinks
      home.file."${config.home.homeDirectory}/.gnupg/pubring.kbx" =
      ...
      home.file."${config.xdg.configHome}/OpenRGB/OpenRGB.json" =
        mkIf config.confSymlinks.configs.openrgb
          {
            text = ''
              {
                  "AutoStart": {
      ...
      home.file."${config.xdg.configHome}/jellyfin-mpv-shim/conf.json" =
        mkIf config.confSymlinks.configs.jellyfinShim
          {
            text = ''
              {
      ...
      home.file."${config.xdg.configHome}/streamdeck-ui/streamdeck_ui.json" =
        mkIf config.confSymlinks.configs.streamdeckui
          {
            text = ''
              {
                  "state": {
