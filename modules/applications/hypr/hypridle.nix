        ...
        hypridle = with pkgs; {
          ...
          settings = {
            general = {
              ...
              after_sleep_cmd = "sleep 1; ${undim_screen.outPath}/bin/undim_screen; hyprctl --batch 'sleep 2; dispatch dpms on; dispatch exec makoctl mode -s default; dispatch exec openrgb -p ${config.xdg.configHome}/OpenRGB/MainBlue.orp; dispatch exec qpwgraph -ma ${config.xdg.configHome}/qpwgraph/default.qpwgraph'";
